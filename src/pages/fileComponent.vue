<script>
const contractInfo = [
    { label: '合同编号', value: '{(系统生成,不可编辑)XX}' },
    { label: '采购人(甲方)', value: '{(继承信息,不可编辑)采购单位名称}' },
    { label: '供应商(乙方)', value: '{(继承信息,不可编辑)供应商名称}' },
    { label: '签订地点', value: '', editable: true },
    { label: '签订时间', value: '{取值供应商签章时间，不可编辑}' }
]
const contractInfo1 = [
    { label: '采购项目名称', value: '{(继承信息,不可编辑)XX}' },
    { label: '采购项目编号', value: '{(继承信息,不可编辑)XX}' },
    { label: '采购计划编号', value: '{(系统生成,不可编辑)XX}' },
    { label: '政府采购组织形式', value: '{(继承信息,不可编辑)XX}' },
    { label: '政府采购方式', value: '{(继承信息,不可编辑)XX}' },
    {
        label: '落实政府采购政策情况', value: '', children: [{
            label: '中标（成交）采购的服务单位是否为中小企业',
            value: '{(预设内容，可选择)是/否}'
        }, {
            label: '本合同是否为专门面向中小企业的采购合同（中小企业预留合同）',
            value: '{(继承信息，不可编辑)是/否}'
        }, {
            label: '若本项目不专门面向中小企业采购，是否给予小微企业评审优惠',
            value: '{(继承信息，不可编辑)是/否}'
        }, {
            label: '中标（成交）采购标的供应商是否为残疾人福利性单位',
            value: '{(预设内容，可选择)是/否}'
        }, {
            label: '中标（成交）采购标的供应商是否为监狱企业',
            value: '{(预设内容，可选择)是/否}'
        }]
    },
    { label: '中标（成交）供应商是否为外商投资企业', value: '{(预设内容，可选择)是/否}' }
]
const contractInfo2 = [
    { title: '质量要求', value: '' },
    { title: '包装方式及运输方式', value: '' },
    { title: '.质量保修范围和保修期', value: '' },
    { title: '其他要求', value: '' }
]
const deliveryTime = ref(null)
</script>
<template>
    <div><el-button type="default" @click="getPdf('exportContent', '合同')">导出合同</el-button></div>
    <div id="exportContent" class="contract-wrapper">
        ...
        <div class="contract-header text-center mb-8">
            ...
            <!-- 新增居中容器：所有行在这个容器内居中 -->
            <div class="contract-info-center">
            ...
            <div class="contract-section mb-6">
                ...
                <div class="section-content">
                    ...
                    <div class="project-table mt-6 mb-6">
                        ...
                        <el-table :data="targetList" border class="contract-table"
                            ...
                            <el-table-column label="单价(元)" align="center">
                                <template #default="scope">
                                    ...
                                    <el-input v-model="scope.row.price" type="number" :disabled="!scope.row.editable"
                                        class="font-mono text-right"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="数量" align="center">
                                <template #default="scope">
                                    <el-input v-model="scope.row.quantity" type="number" :disabled="!scope.row.editable"
                                        class="font-mono text-right"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="金额(元)" align="center">
                                <template #default="scope">
                                    <el-input v-model="scope.row.amount" type="number" :disabled="!scope.row.editable"
                                        class="font-mono text-right"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="计量单位" align="center">
                                <template #default="scope">
                                    <el-input v-model="scope.row.unit" :disabled="!scope.row.editable"
                                        class="font-mono"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="品牌" align="center">
                                <template #default="scope">
                                    <el-input v-model="scope.row.brand" :disabled="!scope.row.editable"
                                        class="font-mono"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="规格型号" align="center">
                                <template #default="scope">
                                    <el-input v-model="scope.row.spec" :disabled="!scope.row.editable"
                                        class="font-mono"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column label="操作" width="100" align="center">
                                <template #default="scope">
                                    <el-button size="mini" @click="scope.row.editable = !scope.row.editable"
                                        class="text-xs">
                    ...
                    <div class="condition-module mt-6">
                        ...
                        <div v-if="showModules.infoProduct" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">涉及信息类产品：</h4>
                            <el-table :data="infoProductList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                                <el-table-column label="标的名称" align="center">
                                    <template #default="scope">
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                注：关键部件是指财政部会同有关部门发布的政府采购需求标准规定的需要通过国家有关部门指定的测评机构开展的安全可靠测评的软硬件，如CPU芯片、操作系统、数据库等。</p>
                        </div>
                    </div>
                    ...
                    <div class="condition-module mt-4">
                        ...
                        <div v-if="showModules.newEnergyCar" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">涉及采购新能源汽车：</h4>
                            <el-table :data="newEnergyCarList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                    ...
                    <div class="condition-module mt-4">
                        <el-checkbox v-model="showModules.newEnergyCar" label="涉及强制采购节能产品"></el-checkbox>
                        <div v-if="showModules.newEnergyCar" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">涉及强制采购节能产品：</h4>
                            <el-table :data="newEnergyCarList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                                <el-table-column label="采购品目名称" align="center">
                    ...
                    <div class="condition-module mt-4">
                        ...
                        <div v-if="showModules.subcontract" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">合同分包：</h4>
                            <el-table :data="subcontractList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                    ...
                    <!-- 其他条件模块（进口产品、节能产品等） -->
                    <div class="condition-module mt-4">
                        <el-checkbox v-model="showModules.importProduct" label="涉及优先采购环境标志产品"></el-checkbox>
                        <div v-if="showModules.importProduct" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">涉及优先采购环境标志产品：</h4>
                            <el-table :data="importProductList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                                <el-table-column label="采购品目名称" align="center">
                                    <template #default="scope">
                    ...
                    <div class="condition-module mt-4">
                        <el-checkbox v-model="showModules.importProduct" label="涉及绿色产品"></el-checkbox>
                        <div v-if="showModules.importProduct" class="module-content mt-3 border border-gray-300 p-4">
                            <h4 class="module-title font-bold mb-3">涉及绿色产品：</h4>
                            <el-table :data="importProductList" border class="contract-table"
                                :header-cell-style="tableHeaderStyle">
                                <el-table-column label="序号" type="index" width="60" align="center"></el-table-column>
                                <el-table-column label="采购品目名称" align="center">
            ...
            <div class="contract-section mb-6">
                ...
                <div class="section-content pl-4">
                    <div class="requirement-item mb-4" v-for="(item, index) in contractInfo2" :key="index">
                        ...
                        <el-input v-model="goodsRequirements.quality" type="textarea" :rows="4"
            ...
            <div class="contract-section mb-6">
                ...
                <div class="section-content pl-4">
                    <div class="info-row mb-2">
                        ...
                        <el-date-picker v-model="deliveryTime" type="daterange" range-separator="至"
                            start-placeholder="开始日期" end-placeholder="结束日期" class="font-mono" />
                    </div>
                    <div class="info-row mb-2">
                    ...
                    <div class="info-row mb-2">
                        ...
                        <el-input v-model="riskMeasure" type="textarea" :rows="2"
                            class="contract-textarea font-sans"></el-input>
                    </div>
                </div>
            </div>
                ...
                <div class="section-content pl-4">
                    ...
                    <div class="copy-info mb-4">
                        ...
                        <span class="ml-4">（甲方持有 <el-input v-model="partyACopy" type="number"
                                class="inline-input w-10 font-mono">份</el-input>，乙方持有 <el-input v-model="partyBCopy"
                                type="number" class="inline-input w-10 font-mono">份</el-input>，项目同级财政部门备案 <el-input
